  ...
  return (
    <main className="grid min-h-screen place-items-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            <Badge variant="secondary">Подтверждение email</Badge>
            ...
            <p className="text-sm leading-6 text-slate-600">
              Если регистрация доступна для указанного email, Supabase отправил
              одноразовую ссылку подтверждения.
            </p>
          </CardHeader>
          <CardContent className="space-y-3 text-sm leading-6 text-slate-600">
            <p>Проверьте папки «Спам» и «Промоакции».</p>
            <p>
              Доставка может занять несколько минут. Не отправляйте повторные
              запросы подряд: Supabase ограничивает частоту Auth-писем.
            </p>
          </CardContent>
        </Card>
      </div>
